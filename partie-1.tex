...
%
            \begin{figure}[h]
                \centering
                \includegraphics[scale=0.6]{RSC/1-1.png}
                \caption{ Schéma du réseau à commutation de circuit étudié }
                \label{ Schema du reseau a commutation de circuit }
            \end{figure}
%
            \paragraph{}
Chacune des connexions nécessite un débit de 64 Kb/s de façon bi-directionnel.
...
\end{center}
        \paragraph{}
Voici les résultats de ce calcul, obtenus grâce au script (cf. \ref{seullien-script}})
    % TODO >>>
